    ...
    <div class="container-fluid">
      <div class="row justify-content-center">
        <div class="form-holder text-center">
          <form class="form-inline" enctype="multipart/form-data" @submit.prevent="handleFormSubmit">
            <fieldset>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input v-model="author" type="text" id="author" name="author" placeholder class="input-xlarge" />
                </div>
              </div>
              <br />
              <div class="control-group">
